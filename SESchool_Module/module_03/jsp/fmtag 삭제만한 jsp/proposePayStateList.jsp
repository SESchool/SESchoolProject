...
<%
	...
	while ( list != null && list.next() ) {
		...
		if ( !v_represent.equals("") && v_recogstate.equals("Y") ) {
			// 수강생 정보확인하는 버튼추가
			v_recogstatenm = "완료<br/><a href=\"#none\" onclick=\"showStudentInfo('"+v_represent+"','"+v_subj+"','"+v_subjseq+"','"+v_recogstate+"');\"><img src=\"/images/template0/common/btn_mycampus_view.gif\"></a>";
		} else if ( !v_represent.equals("") && v_recogstate.equals("N") ){
			v_recogstatenm = "입금대기<br/><a href=\"#none\" onclick=\"showStudentInfo('"+v_represent+"','"+v_subj+"','"+v_subjseq+"','"+v_recogstate+"');\"><img src=\"/images/template0/common/btn_mycampus_view.gif\"></a>";
		}
